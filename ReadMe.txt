In this branch there is terraform work which of VPC with two public and private subnets and route tables for each subnet and security groups to allow port 80 and 443 from the internet.I have created different variables for that.
